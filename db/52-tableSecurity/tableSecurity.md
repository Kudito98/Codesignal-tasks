<p>As the head of a company you decided that it's time to introduce access control and to restrict access to <strong>employees</strong> table for all the employees. The table has the following structure:</p>
<ul>
