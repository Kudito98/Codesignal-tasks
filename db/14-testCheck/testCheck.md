<p>Your professor gave the class a bonus task: Write a program that will check the answers for the latest test. The program will be given a table <strong>answers</strong> with the following columns:</p>
<ul>
